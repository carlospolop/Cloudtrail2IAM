...
def main():
    ...
    parser.add_argument('--bucket-name', required=True, help='The S3 bucket name containing CloudTrail logs. e.q.: "AWSLogs/<acc-id>/CloudTrail/"')
    parser.add_argument('--profile', required=True, help='The AWS profile to use for accessing the S3 bucket')
    parser.add_argument('--threads', type=int, default=20, help='The number of threads to use for processing log files (default: 20)')
